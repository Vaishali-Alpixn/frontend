  ...
  return (
    <div className="w-full bg-white border-b border-gray-300 shadow px-6 py-4 flex items-center justify-between">
      <div className="flex items-center space-x-4">
        <img src="https://i.pinimg.com/564x/c7/4c/78/c74c78c049af7061319694743ccb0f8e.jpg" alt="Logo" className="w-10 h-10 object-cover rounded-full" />

        <div className="text-gray-700 text-lg">
          Hello, <span className="font-semibold text-black">Katherine</span>
        </div>
      </div>
